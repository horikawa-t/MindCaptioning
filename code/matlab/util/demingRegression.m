function [slope,intercept,stats,xymu]=demingRegression(x,y,intercept0,lambda,null_slope,tail,nfold)
...
%  nfold: the number of fold for S.E. estimation (default = # of samples)
%
%
% [Output]
%  slope: slope
